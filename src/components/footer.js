...
return (
    <footer className="footer footer-center bg-black rounded p-10">
        <nav className="grid grid-flow-col gap-4">
            <Link href="#about" className="link link-hover text-white">À propos</Link>
            <Link href="#projects" className="link link-hover text-white">Projets</Link>
        ...
        <nav>
            <div className="grid grid-flow-col gap-4">
                <a href="https://github.com/Alexmz1" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current overflow-visible text-white">
        ...
        <aside>
            <p className="text-white">© {new Date().getFullYear()} - Tous droits réservés | Alexis Menez</p>
        </aside>
    </footer>
);
}
